...
export default function ElectroStore({ electroShards, tronics, setTronics, setNotifications, onBuyTronicsBoost, onBack }) {
  const [currentSection, setCurrentSection] = useState('average');
  ...
  return (
    <div className="store-container">
      ...
      <div className="store-sections">
        <button 
          className={`section-button ${currentSection === 'average' ? 'active' : ''}`}
          onClick={() => setCurrentSection('average')}
        >
          Average Tech
        </button>
        <button 
          className={`section-button ${currentSection === 'premium' ? 'active' : ''}`}
      ...
      <div className="store-items">
        {currentSection === 'average' ? (
          ...
          <div className="coming-soon">
            <h3>Premium Tech Coming Soon!</h3>
            <p>More advanced electronic upgrades will be available after future updates.</p>
          </div>
        )}
      </div>
    </div>
