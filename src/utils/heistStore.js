...
export const useHeistStore = create(
  persist(
    (set, get) => ({
      crewMembers: [
        { id: 1, name: 'Shadow', stealth: 75, combat: 45, skill: 60, cost: 50000, available: true },
        { id: 2, name: 'Bruiser', stealth: 30, combat: 85, skill: 55, cost: 75000, available: true },
        { id: 3, name: 'Tech', stealth: 65, combat: 35, skill: 80, cost: 100000, available: true },
      ],
      activeHeist: null,
      assignedCrew: [],
      heistProgress: 0,
